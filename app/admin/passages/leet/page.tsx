      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="group relative inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 overflow-hidden"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-violet-600 to-fuchsia-600 opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
            </Link>
          </div>
        </div>
        ...
        <div className="mb-6 space-y-4">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-violet-400 rounded-2xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white hover:border-purple-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all shadow-sm disabled:bg-gray-50 disabled:text-gray-400"
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div className="text-lg font-semibold text-gray-700">
              총 <span className="text-purple-600">{filteredPassages.length}</span>개의 지문
            </div>
          </div>
        </div>
            ...
            return (
              <div key={year} className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl shadow-xl overflow-hidden">
                <button
                  ...
                  className="w-full px-6 py-4 bg-gradient-to-r from-purple-600 to-violet-600 text-white flex items-center justify-between hover:from-purple-700 hover:to-violet-700 transition-all"
                >
                  <div className="flex items-center gap-3">
                    <svg 
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {typePassages.map((p: any) => (
                                  <Link
                                    ...
                                    className="group relative bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl p-5 hover:shadow-xl hover:shadow-purple-200/50 transition-all duration-300 transform hover:-translate-y-1 overflow-hidden"
                                  >
                                    ...
                                    <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform group-hover:translate-x-1">
                                      <svg 
                                        className="w-4 h-4 text-purple-500 drop-shadow-md" 
                                        fill="none" 
                                        stroke="currentColor" 
                                        viewBox="0 0 24 24"
                                      >
        ...
        {filteredPassages.length === 0 && (
          <div className="text-center py-20">
            <div className="inline-block p-8 bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl shadow-xl">
              ...
              <Link
                href="/admin/passages/new/leet"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
              >
