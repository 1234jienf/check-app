...
import TeacherHomeworkCalendar from "@/components/TeacherHomeworkCalendar";
    ...
    <div className="min-h-screen p-6 md:p-10" style={{ backgroundColor: '#F0EEEB' }}>
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 md:mb-8">
          ...
          <p className="text-sm md:text-base" style={{ color: '#13181B', opacity: 0.8 }}>학생들에게 내줄 공통 일별 숙제를 추가하고 관리하세요.</p>
        </div>
