...
export default function KoreanStudentPage() {
  useEffect(() => {
    if (typeof window !== 'undefined') {
      sessionStorage.setItem('selectedSubject', 'korean');
      window.dispatchEvent(new CustomEvent('subjectChanged', { detail: { subject: 'korean' } }));
    }
  }, []);
  return (
    <div className="min-h-screen p-6 md:p-10" style={{ backgroundColor: '#F0EEEB' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link
            href="/student/korean/passages/ebs"
          ...
          <Link
            href="/student/korean/passages/gichul"
            className="group relative rounded-xl p-6 shadow-sm transition-all duration-200"
            style={{ backgroundColor: '#F0EEEB' }}
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = '#CCD5DA';
          ...
          <Link
            href="/student/korean/passages/leet"
            className="group relative rounded-xl p-6 shadow-sm transition-all duration-200"
            style={{ backgroundColor: '#F0EEEB' }}
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = '#CCD5DA';
          ...
          <Link
            href="/student/korean/passages/other"
            className="group relative rounded-xl p-6 shadow-sm transition-all duration-200"
            style={{ backgroundColor: '#F0EEEB' }}
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = '#CCD5DA';
